...
<head>
    ...
    <!-- Stylesheets -->
    <link href="{{ url('vendor/bellaria/css/bootstrap.css') }}" rel="stylesheet">
    <link href="{{ url('vendor/bellaria/plugins/revolution/css/settings.css') }}" rel="stylesheet" type="text/css">
    <!-- REVOLUTION SETTINGS STYLES -->
    <link href="{{ url('vendor/bellaria/plugins/revolution/css/layers.css') }}" rel="stylesheet" type="text/css">
    <!-- REVOLUTION LAYERS STYLES -->
    <link href="{{ url('vendor/bellaria/plugins/revolution/css/navigation.css') }}" rel="stylesheet" type="text/css">
    <!-- REVOLUTION NAVIGATION STYLES -->

    <link href="{{ url('vendor/bellaria/css/style.css') }}" rel="stylesheet">
    <link href="{{ url('vendor/bellaria/css/responsive.css') }}" rel="stylesheet">

    <link rel="shortcut icon" href="{{ url('vendor/bellaria/images/favicon.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ url('vendor/bellaria/images/favicon.png') }}" type="image/x-icon">
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="footer-column col-lg-4 col-md-12 col-sm-12">
                            ...
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo"><img src="{{ url('fotonya/logo.png') }}" alt="">
                                </figure>
                            </div>
                        </div>
    ...
    <script src="{{ url('vendor/bellaria/js/jquery.js') }}"></script>
    <script src="{{ url('vendor/bellaria/js/popper.min.js') }}"></script>
    <script src="{{ url('vendor/bellaria/js/bootstrap.min.js') }}"></script>
    ...
    <!--Revolution Slider-->
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/jquery.themepunch.revolution.min.js') }}"></script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/jquery.themepunch.tools.min.js') }}"></script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.actions.min.js') }}">
    </script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.carousel.min.js') }}">
    </script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.kenburn.min.js') }}">
    </script>
    <script
        src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}">
    </script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.migration.min.js') }}">
    </script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.navigation.min.js') }}">
    </script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.parallax.min.js') }}">
    </script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js') }}">
    </script>
    <script src="{{ url('vendor/bellaria/plugins/revolution/js/extensions/revolution.extension.video.min.js') }}">
    </script>

    <!--Revolution Slider-->
    <script src="{{ url('vendor/bellaria/js/jquery.fancybox.js') }}"></script>
    <script src="{{ url('vendor/bellaria/js/owl.js') }}"></script>
    <script src="{{ url('vendor/bellaria/js/wow.js') }}"></script>
    <script src="{{ url('vendor/bellaria/js/appear.js') }}"></script>
    <script src="{{ url('vendor/bellaria/js/script.js') }}"></script>
