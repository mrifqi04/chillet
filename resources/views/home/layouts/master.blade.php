...
<link href="{{asset('vendor/bellaria')}}/plugins/revolution/css/settings.css" rel="stylesheet" type="text/css"><!-- REVOLUTION SETTINGS STYLES -->
<link href="{{asset('vendor/bellaria')}}/plugins/revolution/css/layers.css" rel="stylesheet" type="text/css"><!-- REVOLUTION LAYERS STYLES -->
<link href="{{asset('vendor/bellaria')}}/plugins/revolution/css/navigation.css" rel="stylesheet" type="text/css"><!-- REVOLUTION NAVIGATION STYLES -->
...
<!--[if lt IE 9]><script src="{{asset('vendor/bellaria')}}/https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.js"></script><![endif]-->
                ...
                <div class="row">
                    ...
                    <div class="footer-column col-lg-4 col-md-12 col-sm-12">
                        ...
                        <div class="footer-widget logo-widget">
                            <figure class="footer-logo"><img src="{{asset('fotonya/logo.png')}}" alt=""></figure>
                        </div>
                    </div>
...
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="{{asset('vendor/bellaria')}}/plugins/revolution/js/extensions/revolution.extension.video.min.js"></script>
